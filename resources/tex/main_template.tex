...
\startfrontmatter % Intro material
    ...
    \blank
    % {\midaligned { \externalfigure[https://cdn.door43.org/obs/jpg/uWOBSverticallogo1200w.png] } }
    {\midaligned { \externalfigure[/opt/obs/png/uWOBSverticallogo1200w.png] } }
    \blank
    \stopmakeup
    ...
    % \starthanging{\externalfigure[https://unfoldingword.org/assets/img/uW-Level-<<<[checkinglevel]>>>-128px.png]}
    \starthanging{\externalfigure[/opt/obs/png/uW-Level-<<<[checkinglevel]>>>-128px.png]}
