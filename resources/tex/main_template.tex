...
\startfrontmatter % Intro material
    ...
    % \starthanging{\externalfigure[https://unfoldingword.org/assets/img/uW-Level-<<<[checking_level]>>>-128px.png]}
    % \starthanging{\externalfigure[/opt/obs/png/uW-Level-<<<[checking_level]>>>-128px.png]}
    % {{\bf Checking level <<<[checking_level]>>>}\blank
